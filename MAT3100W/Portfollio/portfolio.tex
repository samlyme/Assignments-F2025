...
\begin{example}
    ...
    Thus, we can construct the function \(f: A \rightarrow B\) as \(f(a_i) = b_i\). 
...
\begin{example}
    ...
    Thus, for all \(f: A \rightarrow B\), \(f\) is either not injective or it is 
    not surjective.
...
\subsection{Quantifiers}
    \todo[inline, color=red!50]{Feedback requested. [Are these propositions good enough?]}
