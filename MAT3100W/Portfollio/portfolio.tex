...
\begin{definition}
    Real number \(\mathbb{R}\): the set of all numbers on our number line.
\end{definition}

\subsubsection{Combinatorics: combinations, permutations, and factorials.}

\begin{definition}
    Combinations: the cardinality of the set of all subsets of a specific cardinality.
\end{definition}

\begin{definition}
    Permutations: the cardinality of the set of all orderings of a specific length.
\end{definition}
...
Using the properties of modular arithmetic \ref{def:modular-arithmetic},
